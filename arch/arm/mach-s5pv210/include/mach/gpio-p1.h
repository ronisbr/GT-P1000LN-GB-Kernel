...
#if defined(CONFIG_TARGET_LOCALE_LTN_L)||defined(CONFIG_TARGET_LOCALE_LTN_N) // Rev1.0 (Only latin HW04)  
...
#if defined(CONFIG_TARGET_LOCALE_LTN_L)||defined(CONFIG_TARGET_LOCALE_LTN_N) // ys325.chang 2011.03.04
